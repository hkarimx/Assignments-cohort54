...
/*
In the old version, both success and error messages could appear
because the setTimeout kept running even after an error happened.

With Promises, once we call resolve() or reject(), the Promise is finished
and ignores any later results. So we only get one clear outcome.
*/
